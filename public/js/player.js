...
window.jwplayer = function (t) {
    ...
    function d(t, e, n) {
        ...
        if (a.preload = o(e.preload, u), a.allSources = h(e, t), a.sources = v(a.allSources, i), a.sources.length) return a.file = a.sources[0].file, a.feedData = n, function (t) {
    ...
    function h(t, e) {
        ...
        return (i || r).map((function (e) {
            ...
            m(e, n, "androidhls"), m(e, n, "hlsjsdefault"), m(e, n, "safarihlsjs"), function (t, e, n) {
                if (t.liveSyncDuration) return;
                var r = e.liveSyncDuration ? e : n;
                m(t, r, "liveSyncDuration")
            }(e, t, n), m(e, n, "_hlsjsProgressive"), e.preload = o(e.preload, u);
            var r = e.drm || c || n.drm;
            r && (e.drm = r);
    ...
    var r = "8.14.0+commercial_v8-14-0.398.commercial.e9a133e.hlsjs.eeefcce.hlsjsprogressive.06278c3.jwplayer.89a1f0a.dai.07e1a38.freewheel.af0c077.googima.3bea836.googimanvmp.6873d1e.headerbidding.c2b079a.vast.fc45163.analytics.f8ec4b5.gapro.141397a"
}, function (t, e, n) {
    "use strict";
    ...
    "use strict";
    var r = n(0), i = n(24), o = n(12), u = n(2), a = n(1), c = n(20), s = function (t) {
        if ("string" == typeof t) {
        ...
        return L(t) ? Promise.resolve() : S(t).then((function () {
            ...
            return S(e = t).then((function () {
                if (!E(e)) {
                    ...
                    return "function" == typeof i ? i : y.a.html5 && "html5" === o ? y.a.html5 : n.load(o).catch((function (t) {
    ...
    var W = Q, U = n(57), X = n(52), Y = n(9), J = n(45), K = n(63), Z = n(64), $ = n(35);
    n(71), n(72);
    n.d(e, "b", (function () {
        return nt
    }));
    ...
    Object(r.j)(G.prototype, {
        on: Y.a.on, once: Y.a.once, off: Y.a.off, trigger: Y.a.trigger, init: function (t, e) {
...
var jwDefaults = {
    ...
    "height": 270,
    "key": "UIRE7/4ZJ9X927+4Bk8JyEydesBECnTfRGqga74EEEnxXc3bkIEhultYQP1+jDa3",
    "ph": 1,
    "pid": "x9b0odt3",
    "preload": "none",
    "repeat": false,
